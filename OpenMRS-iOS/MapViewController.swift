...
class MapViewController : UIViewController
{
    var patient: MRSPatient! {
        didSet {
            ...
            geocoder.geocodeAddressString(patient.formattedPatientAddress()) { (placemark, error) in
    ...
    override func viewDidLoad() {
        ...
        self.view.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-0-[subview]-0-|", options: NSLayoutFormatOptions(), metrics: nil, views: ["subview" : mapView]))
        self.view.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-0-[subview]-0-|", options: NSLayoutFormatOptions(), metrics: nil, views: ["subview" : mapView]))
    }
